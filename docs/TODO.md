...
### 1. Optics FDTD 仿真器编译 ✅ 已完成
- [x] 完善 CMakeLists.txt 配置 (Windows 支持)
- [x] 测试 Windows 编译
- [x] 更新主项目 setup.py 编译配置
- [x] 验证模块导入和功能
...
### 7. 可视化模块 ✅ 已完成
- [x] 实现 `interfaces/visualization/field.py` - 场分布可视化
  - [x] 电场/磁场分量可视化
  - [x] 强度和相位图
  - [x] 坡印廷矢量
  - [x] 横截面绘制
  - [x] 动画支持
- [x] 实现 `interfaces/visualization/structure.py` - 结构可视化
  - [x] 设计参数分布
  - [x] 二值结构
  - [x] 多层结构
  - [x] 光栅/波导示意图
...
- [x] workflows 测试 ✅ 2026-03-22
  ...
  - [x] Dispatcher 测试
- [x] GNN 示例 ✅ 2026-03-22
  - [x] 创建 `examples/11_gnn_inverse_design.py`
  - [x] 图结构可视化
  - [x] 注意力权重可视化
  - [x] 逆向设计示例
  - [x] 架构比较 (GCN/GAT/GraphSAGE)
- [x] 数据模块完善 ✅ 2026-03-22
  - [x] 数据生成器基类
